        ...
        var calendarEl = document.getElementById('calendar');
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [
                {
                    ...
                    end: '2022-10-26 12:00:00'
                },
                {
                    title: 'Long Event',
                    start: '2022-10-26 13:00:00',
                    end: '2022-10-26 16:30:00'
                }]
            });
            calendar.render();
        });
    ...
    <section class="services" id="services">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>Aqui você pode pedir ajuda, tirar duvidas e fazer reclamações</p>
            ...
            <div class="box">
                ...
                <p>Aqui você poderá saber quais medicamentos estão disponiveis e sua quantidade</p>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <div id='calendar'></div>
                <!--?php
                    echo "<h2>Hoje - <u>$diasemana[$diasemana_numero]</u></h2>";
                ?>
        ...
        <span>
            ...
            <section class="book" id="book">
                ...
                <div class="row">
                    ...
                    <form>
                        <h3>Escreva sua experiencia</h3>
                        <input type="text" placeholder="Seu nome" class="box">
                        <textarea name="experiencia" rows="10" cols="30" class="box" placeholder="Digite sua experiencia aqui!"></textarea>
                        <button class="btn" onclick="exper()">Enviar</button>
                    </form>
                </div>
            ...
            <section class="footer">
                ...
                <div class="box-container">
                    ...
                    <div class="box">
                        ...
                        <a href="#"> <i class="fas fa-chevron-right"></i> Agendamentos </a>
                        <a href="#"> <i class="fas fa-chevron-right"></i> Medicamentos </a>
                    ...
                    <div class="box">
                        ...
                        <a href="#"> <i class="fas fa-chevron-right"></i> Dentista </a>
                        <a href="#"> <i class="fas fa-chevron-right"></i> Diagnosticos </a>
                        <a href="#"> <i class="fas fa-chevron-right"></i> Cardiologia </a>
                        <a href="#"> <i class="fas fa-chevron-right"></i> Ambulancia </a>
                    ...
                    <div class="box">
                        ...
                        <a href="#"> <i class="fas fa-envelope"></i> 4Healthcontato@gmail.com </a>
                ...
                <div class="credit"> Criado por <span>4Health</span> | Etec Pedro Fereira Alves </div>
